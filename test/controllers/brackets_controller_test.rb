...
class BracketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bracket" do
    assert_difference("Bracket.count") do
      post brackets_url, params: { bracket: { name: @bracket.name, season: @bracket.season } }
    end
  ...
  test "should update bracket" do
    patch bracket_url(@bracket), params: { bracket: { name: @bracket.name, season: @bracket.season } }
