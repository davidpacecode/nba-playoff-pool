...
class PicksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pick" do
    assert_difference("Pick.count") do
      post picks_url, params: { pick: { predicted_winner_id: @pick.predicted_winner_id, series_id: @pick.series_id, user_id: @pick.user_id } }
    end
  ...
  test "should update pick" do
    patch pick_url(@pick), params: { pick: { predicted_winner_id: @pick.predicted_winner_id, series_id: @pick.series_id, user_id: @pick.user_id } }
