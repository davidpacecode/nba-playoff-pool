class SeriesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to series_index_path, notice: "Series was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def series_params
      params.expect(series: [ :round, :conference, :top_seed_id, :bottom_seed_id, :top_seed_wins, :bottom_seed_wins, :winner_id, :status, :next_game_at, :seed_slot ])
    end
end
