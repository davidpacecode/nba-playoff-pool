class PicksController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @pick.update(pick_params)
        format.html { redirect_to @pick, notice: "Pick was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to picks_path, notice: "Pick was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_pick
      @pick = Pick.find(params.expect(:id))
    end
